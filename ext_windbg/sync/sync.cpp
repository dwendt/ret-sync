...
static char *g_DefaultHost = (char *)"127.0.0.1";
static char *g_DefaultPort = (char *)"9100";
...
modmd5(LPSTR *hexhash)
{
    ...
    hFile = CreateFileA(g_NameBuffer, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_FLAG_SEQUENTIAL_SCAN, NULL);
    if (hFile == INVALID_HANDLE_VALUE)
    {
